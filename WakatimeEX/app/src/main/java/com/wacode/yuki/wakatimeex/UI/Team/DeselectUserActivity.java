 ...
 */
public class DeselectUserActivity extends AppCompatActivity{
    ...
    private void setRecyclerView(){
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(DeselectUserActivity.this));
        ...
        UserCheckRecyclerAdapter adapter = new UserCheckRecyclerAdapter(DeselectUserActivity.this, mCheckList);
    ...
    private View.OnClickListener onClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            setDeselectUserDialog();
        }
    };

    private void setDeselectUserDialog(){
        AlertDialog.Builder dialog = new AlertDialog.Builder(DeselectUserActivity.this);
        dialog.setMessage(R.string.deselect_dialog_message);
        dialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                // TODO: 2016/06/11 deselect user
            }
        });
